...
public record Material(Color color, double ambient, double diffuse, double specular, int shininess, boolean isMetallic){
    ...
    public static Material PINK     = new Material(Color.PINK  ,  .2, .9, .1, 0, false);
    ...
    public static Material AZURE    = new Material(Color.AZURE ,  .2, .9, .1, 0, false);
    ...
    public static Material GOLD     = new Material(Color.GOLD ,   .2, .9, .9, 200, true);
    public static Material SILVER   = new Material(Color.SILVER , .2, .9, .9, 200, true);
    public static Material BRONZE   = new Material(Color.BRONZE , .2, .9, .9, 200, true);
    public static Material COPPER   = new Material(Color.COPPER , .2, .9, .9, 200, true);
}
